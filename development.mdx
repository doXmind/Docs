---
title: 'Development'
description: 'Learn how to develop with doXmind SDK and APIs'
---
...
```bash Go
go get github.com/doxmind/doxmind-go
```
...
```go Go
import "github.com/doxmind/doxmind-go"

client := doxmind.NewClient(
    doxmind.WithAPIKey(os.Getenv("DOCMIND_API_KEY")),
    doxmind.WithWorkspace(os.Getenv("DOCMIND_WORKSPACE_ID")),
)
```
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/doxmind/examples"
  >
