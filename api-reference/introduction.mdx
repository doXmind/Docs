...
description: 'Introduction to the doXmind REST API'
---
...
<Note>
  Get your API key from the [Dashboard](https://app.doxmind.com/settings/api-keys)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    title="AI Operations"
    icon="brain"
    href="/api-reference/endpoints/ai"
  >
  ...
  <Card
    title="Templates"
    icon="copy"
    href="/api-reference/endpoints/templates"
  >
  ...
  <Card
    title="Webhooks"
    icon="webhook"
    href="/api-reference/endpoints/webhooks"
  >
